import { ref, onMounted, unref, useSSRContext, mergeProps, watch, withCtx, openBlock, createBlock, createCommentVNode, createVNode } from "vue";
import { ssrRenderComponent, ssrInterpolate, ssrIncludeBooleanAttr, ssrRenderAttrs, ssrRenderClass, ssrRenderSlot } from "vue/server-renderer";
import { usePage, Link } from "@inertiajs/vue3";
import { ExclamationCircleIcon, SunIcon, MoonIcon, HomeIcon, ArrowUpOnSquareStackIcon, FolderIcon, TableCellsIcon, UserIcon } from "@heroicons/vue/24/solid";
const _sfc_main$2 = {
  __name: "TopBar",
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, { isOpen: isOpen.value }, null, _parent));
      _push(`</button><h2 class="${ssrRenderClass([
        "text-xl font-bold transition-opacity",
        isOpen.value ? "opacity-100" : "hidden opacity-0"
      ])}"> Dashboard </h2></div><div class="flex flex-1 items-start"><nav class="w-full"><ul class="menu w-full font-bold"><div class="divider my-1 shrink-0"></div><li class="rounded">`);
      _push(ssrRenderComponent(unref(Link), {
        href: "/dashboard",
        class: [
          "relative flex items-center py-4",
          {
            "bg-primary/10": isActive("/dashboard")
          },
          !isOpen.value && "justify-center"
        ]
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<span class="${ssrRenderClass(["ml-2", !isOpen.value && "hidden"])}"${_scopeId}>Home</span>`);
          } else {
            return [
              isActive("/dashboard") ? (openBlock(), createBlock("div", {
                key: 0,
              ...
              createVNode("span", {
                class: ["ml-2", !isOpen.value && "hidden"]
              }, "Home", 2)
            ];
          }
        }),
      ...
      _push(`</li><li class="rounded">`);
      _push(ssrRenderComponent(unref(Link), {
        href: "/uploadfile",
        class: [
          "relative flex items-center py-4",
          {
            "bg-primary/10": isActive("/uploadfile")
          },
          !isOpen.value && "justify-center"
        ]
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (isActive("/uploadfile")) {
              _push2(`<div class="absolute left-0 top-0 h-full w-1 bg-primary"${_scopeId}></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(ssrRenderComponent(unref(ArrowUpOnSquareStackIcon), {
              class: [
                "size-5",
                {
                  "text-primary": isActive("/uploadfile")
                }
              ]
            }, null, _parent2, _scopeId));
            _push2(`<span class="${ssrRenderClass(["ml-2", !isOpen.value && "hidden"])}"${_scopeId}>Upload File</span>`);
          } else {
            return [
              isActive("/uploadfile") ? (openBlock(), createBlock("div", {
                key: 0,
                class: "absolute left-0 top-0 h-full w-1 bg-primary"
              })) : createCommentVNode("", true),
              createVNode(unref(ArrowUpOnSquareStackIcon), {
                class: [
                  "size-5",
                  {
                    "text-primary": isActive("/uploadfile")
      ...
      _push(ssrRenderComponent(unref(Link), {
        ...
        class: [
          "relative flex items-center py-4",
          {
            "bg-primary/10": isActive("/myfiles")
          },
          !isOpen.value && "justify-center"
        ]
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(FolderIcon), {
              class: [
                "size-5",
                {
                  "text-primary": isActive("/myfiles")
                }
              ]
            }, null, _parent2, _scopeId));
            _push2(`<span class="${ssrRenderClass(["ml-2", !isOpen.value && "hidden"])}"${_scopeId}>My Files</span>`);
          } else {
            return [
              isActive("/myfiles") ? (openBlock(), createBlock("div", {
                key: 0,
                class: "absolute left-0 top-0 h-full w-1 bg-primary"
              })) : createCommentVNode("", true),
              createVNode(unref(FolderIcon), {
                class: [
                  "size-5",
                  {
                    "text-primary": isActive("/myfiles")
      ...
      _push(ssrRenderComponent(unref(Link), {
        ...
        class: [
          "relative flex items-center py-4",
          {
            "bg-primary/10": isActive("/hextable")
          },
          !isOpen.value && "justify-center"
        ]
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (isActive("/hextable")) {
              _push2(`<div class="absolute left-0 top-0 h-full w-1 bg-primary"${_scopeId}></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(ssrRenderComponent(unref(TableCellsIcon), {
              class: [
                "size-5",
                {
                  "text-primary": isActive("/hextable")
                }
              ]
            }, null, _parent2, _scopeId));
            _push2(`<span class="${ssrRenderClass(["ml-2", !isOpen.value && "hidden"])}"${_scopeId}>Hex Table</span>`);
          } else {
            return [
              isActive("/hextable") ? (openBlock(), createBlock("div", {
                key: 0,
                class: "absolute left-0 top-0 h-full w-1 bg-primary"
              })) : createCommentVNode("", true),
              createVNode(unref(TableCellsIcon), {
                class: [
                  "size-5",
                  {
                    "text-primary": isActive("/hextable")
      ...
      _push(`</li><div class="divider my-1 shrink-0"></div><li class="rounded">`);
      _push(ssrRenderComponent(unref(Link), {
        href: "/profile",
        class: [
          "relative flex items-center py-4",
          {
            "bg-primary/10": isActive("/profile")
          },
          !isOpen.value && "justify-center"
        ]
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<span class="${ssrRenderClass(["ml-2", !isOpen.value && "hidden"])}"${_scopeId}>Akun</span>`);
          } else {
            return [
      ...
      _push(`</li></ul></nav></div></div><main class="${ssrRenderClass(["flex-1 p-4", { "ml-24": !isOpen.value, "ml-52": isOpen.value }])}">`);
